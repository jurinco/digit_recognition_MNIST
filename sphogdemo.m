% % Read data
% [tr_labels,tr_feats,te_labels,te_feats] = read_data(ntrain,DATA_PATH);

tr_feats = tr_feats_desk_norm;
te_feats = te_feats_desk_norm;
te_labels = zeros(length(tr_feats),1);
...
save([DATA_PATH 'tr_sphog_feats.mat'], 'tr_sphog_feats')
save([DATA_PATH 'te_sphog_feats.mat'], 'te_sphog_feats')
